...
android {
    namespace = "com.ahmedhaggag.muslimcompanion"
    ...
    defaultConfig {
        ...
        applicationId = "com.ahmedhaggag.muslimcompanion"
...
gradle.taskGraph.whenReady {
    ...
    if (requestsReleaseArtifact && !hasReleaseSigning) {
        throw GradleException("Release signing is not configured. See docs/ANDROID_RELEASE_SIGNING.md.")
    }
}
